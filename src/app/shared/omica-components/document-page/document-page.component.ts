import { Component, AfterViewInit, ElementRef, Input, Output, EventEmitter, Renderer2, SecurityContext, OnChanges, SimpleChanges, HostBinding, HostListener } from '@angular/core';
import { DomSanitizer } from '@angular/platform-browser';
import { scrollToAnchor, genHeadingId, isAnchorLink, removeTrailingHash, rawGithubHref, isGithubHref, isRawGithubHref,} from './document-page.utils';
...
@Component({
  ...
  styleUrls: ['./document-page.less'],
  templateUrl: './document-page.html',
})
export class DocumentPageComponent implements OnChanges, AfterViewInit {
  ...
  /**
   * .document-page class added to host so ::ng-deep gets scoped.
   */
  @HostBinding('class') class: string = 'document-page';
